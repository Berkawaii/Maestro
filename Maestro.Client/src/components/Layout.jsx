...
const SlaSettingsIcon = () => <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>;
const SlaReportsIcon = () => <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>;
                ...
                <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', padding: '0 1rem', marginTop: '1rem' }}>
                    ...
                    {(user?.roles?.includes('Admin') || user?.roles?.includes('SupportAdmin')) && (
                        <>
                            ...
                            <NavItem to="/departments" icon={<DepartmentsIcon />} label={t('departments')} active={isActive('/departments')} collapsed={collapsed} />
                            <NavItem to="/sla-settings" icon={<SlaSettingsIcon />} label={t('slaSettings')} active={isActive('/sla-settings')} collapsed={collapsed} />
                            <NavItem to="/sla-reports" icon={<SlaReportsIcon />} label={t('slaReports')} active={isActive('/sla-reports')} collapsed={collapsed} />
                        </>
                    )}
                </nav>
